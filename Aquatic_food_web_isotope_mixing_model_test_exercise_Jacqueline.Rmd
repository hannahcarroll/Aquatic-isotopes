...
# The summarize_all is to get summary statistics and the .funs is to accept a funtion. sd="sd" is calculating the standard deviation and assigning that value to sd and appending sd to the column name so we know it is the standard deviation.
```
