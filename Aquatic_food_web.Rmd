...
NOTE: WHEN YOU ARE DONE WITH THIS EXERCISE, KNIT THIS TO FILE TO HTML AND SUBMIT VIA BLACKBOARD
...
Try executing this chunk by clicking the *Run* button (green right arrow) within the chunk or by placing your cursor inside it and pressing *Ctrl+Shift+Enter*. 
...
Next, make a simple dual isotope plot of your data. Error bars are plotted for both the x and y axes.
...
Now we will plot the dataset with our two outliers removed. You can see the errorbars more clearly on this plot.
```{r}
